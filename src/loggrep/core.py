...
class LogSearcher:
    ...
    def search_stream(self, input_stream: TextIO) -> Iterator[str]:
        ...
        before_buffer = deque(maxlen=self.before_context if self.before_context > 0 else None)
        after_count = 0
        ...
        for i, line in enumerate(lines):
            ...
            if in_range or not startup_time:
                ...
                is_match = (match and not self.invert_match) or (not match and self.invert_match)
